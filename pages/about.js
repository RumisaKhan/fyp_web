                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-12">
                                <div className="about-image">
                                    <img src="https://res.cloudinary.com/lastshop802/image/upload/v1647804791/about2_toedzg.jpg" className="shadow" alt="image" />
                                    <img src="https://res.cloudinary.com/lastshop802/image/upload/v1647804791/about1_wphdqg.jpg" className="shadow" alt="image" />
                                </div>
                            </div>
