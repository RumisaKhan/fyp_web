                                    ...
                                    <ul className="navbar-nav">
                                        <li className="nav-item">
                                            ...
                                            <ul className="dropdown-menu">
                                                ...
                                                <li className="nav-item">
                                                    <Link href="/necklace" activeClassName="active">
                                                        <a className="nav-link">
                                                            Necklace Store
                                                            <span>New</span>
                                                        </a>
                                                ...
                                                <li className="nav-item">
                                                    <Link href="/earning" activeClassName="active">
                                                        <a className="nav-link">
                                                            Earning Store
                                                            <span>New</span>
                                                        </a>
                                                ...
                                                <li className="nav-item">
                                                    <Link href="/tiaracrown" activeClassName="active">
                                                        <a className="nav-link">
                                                            Tiara Crown Store
                                                            <span>New</span>
                                                        </a>
                                                ...
                                                <li className="nav-item">
                                                    <Link href="/glasses" activeClassName="active">
                                                        <a className="nav-link">
                                                            Glasses Store
                                                            <span>New</span>
                                                        </a>
