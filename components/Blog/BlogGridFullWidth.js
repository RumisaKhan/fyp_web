                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog-post">
                                <div className="post-image">
                                    <Link href="/single-blog-1">
                                        <a>
                                            <img src="https://res.cloudinary.com/lastshop802/image/upload/v1647746858/blog4_plc30v.jpg" alt="image" />
                                        </a>
                                    </Link>
                                    <div className="date">
                                        <span>January 29, 2020</span>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog-post">
                                <div className="post-image">
                                    <Link href="/single-blog-1">
                                        <a>
                                            <img src="https://res.cloudinary.com/lastshop802/image/upload/v1647746859/blog7_tmhram.jpg" alt="image" />
                                        </a>
                                    </Link>
                                    <div className="date">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog-post">
                                <div className="post-image">
                                    <Link href="/single-blog-1">
                                        <a>
                                            <img src="https://res.cloudinary.com/lastshop802/image/upload/v1647746859/blog8_rnzgxd.jpg" alt="image" />
                                        </a>
                                    </Link>
                                    <div className="date">
