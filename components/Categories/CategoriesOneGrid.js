                    ...
                    >
                        <div className="single-offer-products">
                            ...
                            <div className="image">
                                <Link href="/products-without-sidebar-3">
                                    <a>
                                        <img src="https://res.cloudinary.com/lastshop802/image/upload/v1647751261/offer1_fogtqf.jpg" alt="image" />
                                    </a>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="single-offer-products">
                            ...
                            <div className="image">
                                <Link href="/products-without-sidebar-3">
                                    <a>
                                        <img src="https://res.cloudinary.com/lastshop802/image/upload/v1647751260/offer2_idiztt.jpg" alt="image" />
                                    </a>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="single-offer-products">
                            ...
                            <div className="image">
                                <Link href="/products-without-sidebar-3">
                                    <a>
                                        <img src="https://res.cloudinary.com/lastshop802/image/upload/v1647751261/offer3_ifjhbd.jpg" alt="image" />
                                    </a>
                                </Link>
                            </div>
                        </div>
